document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index) {
        // add on click to each square in your gird
        squares[i].onclick = function() {
            console.log('page loaded,', squares[i])
            // if square below current square is empty, user can take that
            ...
            // user cannot take a square if square below it is not taken
    ...
    function checkBoard() {
        ...
        // take each value from each of these winning array and check the corresponding square value
        for (let k = 0; k < winningArrays.length; k++) {
            ...
            // check if all these squares have player one class
            ...
            // check if all these squares have player two class
    ...
    // add an event listener for each click and call checkBoard
